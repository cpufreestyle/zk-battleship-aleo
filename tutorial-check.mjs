...
const server = spawn('node', ['scripts/serve-dist.mjs','--port','4173'], { cwd: process.cwd(), stdio: 'pipe' });
await new Promise(r => server.stdout.on('data', d => d.toString().includes('4173') && r()));
